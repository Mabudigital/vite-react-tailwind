...
function Card({image,title,subtitle,description}) {
  return (
    <div className='@xl:grid @xl:grid-cols-[1fr_3fr] mb-2'>
      <div className='bg-no-repeat bg-cover bg-center h-64 min-h-full rounded-t-3xl @xl:rounded-tr-none @xl:rounded-l-3xl' style={{backgroundImage:`url(${image})`,}}></div>
      <div className='p-2'>
...
function App() {
  ...
  return <div className='max-w-5xl mx-auto mt-4 @container'>
